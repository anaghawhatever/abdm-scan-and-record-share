...
const faqs = [
  { q: "How do I generate a Scan & Record Share QR code for my facility?", a: "QR codes are generated through the ABDM facility registration portal. Each QR encodes the facility's recipient information and a public encryption key (cert URL). { q: "How do I generate a Scan & Record Share QR code for my facility?", a: "QR codes are generated through the ABDM facility registration portal. Each QR encodes the facility's recipient information and a public encryption key (cert URL). Contact both, NHA and your HMIS provider for the QR generation tool." }," },
